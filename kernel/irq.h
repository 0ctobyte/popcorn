 ...
 * enable, disable, ack and clr shall be supported. Some assumptions made here: the number of priority levels, the
...
typedef struct {
    ...
    // Clears the pending interrupt. This should be matched with a prior ack call
