...
({\
    bool result = false;\
    asm inline ("mrs %0, ID_AA64MMFR0_EL1\n"\
                "ubfx %0, %0, #28, #4\n"\
                "cmp %0, #0\n"\
                "cset %0, eq\n"\
                : "+r" (result) :);\
