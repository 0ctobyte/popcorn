...
#define rbtree_make_colour(node, colour)               ((rbtree_node_t*)(((uintptr_t)(node)->parent & ~RBTREE_NODE_RED) | ((colour) & 0x1)))
...
#define rbtree_make_parent(child, new_parent)          ((rbtree_node_t*)((uintptr_t)(new_parent) | ((uintptr_t)(child)->parent & RBTREE_NODE_RED)))
#define rbtree_set_parent(child, new_parent)           ((child)->parent = rbtree_make_parent(child, new_parent))
#define rbtree_which_child(cmp)                        ((cmp) == RBTREE_COMPARE_LT ? RBTREE_CHILD_LEFT : RBTREE_CHILD_RIGHT)
#define rbtree_this_child(parent, child)               ((parent)->children[child])
#define rbtree_slot_init(parent, child)                ((rbtree_slot_t)((uintptr_t)(parent) | ((unsigned long)(child) & 0x1)))
