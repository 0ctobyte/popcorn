...
C_SRCS := $(wildcard boot/*.c) $(wildcard arch/**/*.c) $(wildcard arch/*.c) $(wildcard kernel/*.c) $(wildcard lib/*.c)
S_SRCS := $(wildcard boot/*.s) $(wildcard arch/**/*.s) $(wildcard arch/*.s) $(wildcard kernel/*.s) $(wildcard lib/*.s)
